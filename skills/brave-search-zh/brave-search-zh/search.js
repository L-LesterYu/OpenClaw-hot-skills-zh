...
if (!query) {
	console.log("用法: search.js <查询词> [-n <数量>] [--content]");
	console.log("\n选项:");
	console.log("  -n <数量>    返回结果数量（默认: 5）");
	console.log("  --content    获取可读内容并转为 Markdown");
	console.log("\n示例:");
	console.log('  search.js "javascript async await"');
	console.log('  search.js "rust 编程" -n 10');
	console.log('  search.js "气候变化" --content');
	process.exit(1);
}
